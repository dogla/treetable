...
/**
 * TreeTable to something else converter interface.
 *
 * @author Dominik Glaser
 * 
 * @param <T> the result type of the converter
 */
public interface TreeTableConverter<T> {
	 ...
	 */
	public T convert(TreeTable treeTable);
